(()=>{
  ...
  style.textContent=`
    .gearbox-vibration-cell{padding:3px!important;vertical-align:middle!important;overflow:hidden!important;box-sizing:border-box!important}
    .gearbox-vibration-grid{display:grid!important;grid-template-columns:minmax(0,1fr) minmax(0,1fr)!important;gap:3px!important;width:100%!important;min-width:0!important;max-width:100%!important;box-sizing:border-box!important}
    .gearbox-vibration-grid label{display:flex!important;flex-direction:column!important;gap:2px!important;width:100%!important;min-width:0!important;max-width:100%!important;margin:0!important;box-sizing:border-box!important;overflow:hidden!important}
    .gearbox-vibration-grid span{display:block!important;font-size:9px!important;font-weight:700!important;color:#526674!important;text-align:center!important;line-height:1!important;white-space:nowrap!important}
    .gearbox-vibration-grid input.text-input{display:block!important;width:100%!important;min-width:0!important;max-width:100%!important;height:28px!important;margin:0!important;padding:2px!important;text-align:center!important;box-sizing:border-box!important;font-size:11px!important}
    @media(max-width:850px){
      .gearbox-vibration-cell{padding:2px!important}
      .gearbox-vibration-grid{gap:2px!important}
      .gearbox-vibration-grid span{font-size:8px!important}
      .gearbox-vibration-grid input.text-input{height:26px!important;font-size:10px!important;padding:1px!important}
    }
    @media print{
      .gearbox-vibration-cell{padding:1px!important}
      .gearbox-vibration-grid{gap:1px!important}
      .gearbox-vibration-grid span{font-size:7px!important}
      .gearbox-vibration-grid input.text-input{height:22px!important;font-size:8px!important;padding:0!important}
    }
  `;
